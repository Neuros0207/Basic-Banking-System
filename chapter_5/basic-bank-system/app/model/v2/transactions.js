...
module.exports = {
    ...
    async showAllTransactions(page_number = 1, display_limit=10 , search_amount = 0){
    ...
    async getTransactionsByAccountId(account_number ,page_number =1 , display_limit = 10){
