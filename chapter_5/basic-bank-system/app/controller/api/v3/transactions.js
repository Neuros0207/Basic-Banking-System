        ...
        try {
            ...
            if(role !== 'User'){
                return res.status(401).json({
                    status : 'failed',
                    message : "you're not authorized to access this page! You need to be a user",
                    data: null
                })
            }
            if(status !== 'Open'){
                return res.status(401).json({
                    status : 'failed',
                    message : "you're not authorized to access this page! Your account is currently blocked",
                    data: null
                })
            }
