...
router.post('/api/v3/transactions/transfers', auth, controller.transactionsV3.postTransfer)
router.post('/api/v3/transactions/deposits', auth , controller.transactionsV3.postDeposit)
router.post('/api/v3/transactions/withdraws', auth , controller.transactionsV3.postWithdraw)
// get all transactions data in database with pagination and search features
router.get('/api/v3/transactions', auth, controller.transactionsV3.getTransactions)
// get the details of account all transactions in bank
router.get('/api/v3/transactions/:id', auth ,controller.transactionsV3.getTransactionByAccountId)
router.delete('/api/v3/transactions/:id',auth, controller.transactionsV3.deleteTransactionById)
